...
public class EmptyListView {
    ...
    public static EmptyListView with(View rootView, boolean withLottie){
        return new EmptyListView(rootView, withLottie);
    }

    public EmptyListView(View rootView, boolean withLottie){
        ...
        lottieAnimationView = (LottieAnimationView) rootView.findViewById(R.id.progress_empty_list_lottieView);
        imgView = (ImageView) rootView.findViewById(R.id.progress_empty_list_imgView);
        textTitle = (TextView) rootView.findViewById(R.id.progress_empty_list_textTitle);
        textSubTitle = (TextView) rootView.findViewById(R.id.progress_empty_list_textSubTitle);
        btnOk = (Button) rootView.findViewById(R.id.progress_empty_list_btnOk);

        lottieAnimationView.setVisibility(View.GONE);
        imgView.setVisibility(View.GONE);
    }

    public void pushEmptyListView(View.OnClickListener onClickListener){
        setAnimationView(withLottie ? R.raw.empty_list : R.drawable.empty_list_error);
        btnOk.setOnClickListener(onClickListener);
    }

    public void pushEmptyListView(EmptyListModel model, View.OnClickListener onClickListener){
    ...
    public void pushEmptyListView(int resource, String title, String subtitle, String btnText, View.OnClickListener onClickListener){
